...
ActiveRecord::Schema.define(version: 2021_02_18_081351) do
  ...
  create_table "functions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "line_remind", default: 0, null: false
    t.integer "mail_remind", default: 0, null: false
    t.integer "diary_mode", default: 0, null: false
    t.integer "memo_mode", default: 0, null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "lineaccounts", "users"
